declare module "thinky" {
    ...
    module connect {
        export interface Model<UDocument extends Document<any, any, any>, UModel extends Model<any, any, any>, UAttributes> extends Table<UDocument>, events.EventEmitter {
            ...
            hasOne<SecondUModel extends Model<any, any, any>>(OtherModel: SecondUModel, fieldName: string, leftKey: string, rightKey: string, options: RelationshipOptions): any;
            belongsTo<SecondUModel extends Model<any, any, any>>(OtherModel: SecondUModel, fieldName: string, leftKey: string, rightKey: string, options: RelationshipOptions): any;
            hasMany<SecondUModel extends Model<any, any, any>>(OtherModel: SecondUModel, fieldName: string, leftKey: string, rightKey: string, options: RelationshipOptions): any;
            hasAndBelongsToMany<SecondUModel extends Model<any, any, any>>(OtherModel: SecondUModel, fieldName: string, leftKey: string, rightKey: string, options: RelationshipOptions): any;
            pre(event: string, hook: HookFunction): any;
            post(event: string, hook: HookFunction): any;
    ...
    class R {
        count: Aggregator;
        connect(host: ConnectionOptions, cb: (err: Error, conn: Connection) => void): any;
    ...
    class Cursor {
        ...
        each(cb: (err: Error, row: any) => boolean, done?: () => void): any; // returning false stops iteration
        next(cb: (err: Error, row: any) => void): any;
        toArray(cb: (err: Error, rows: any[]) => void): any;
        close(): any;
    }
